...
import {
  ChevronRight, MapPin, Phone, Mail, Clock, MessageSquare, Building2,
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 sm:mb-12 border-b border-stone-100 pb-6 sm:pb-8">
          <nav className="flex items-center text-sm text-stone-500 mb-6 overflow-x-auto whitespace-nowrap">
            ...
            <span className="text-stone-900 font-medium">{LABELS.BIZE_ULASIN}</span>
          </nav>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif text-stone-900 mb-4">
            Bize Ulaşın
          </h1>
          <p className="text-stone-600 max-w-2xl text-base sm:text-lg leading-relaxed">
        ...
        {/* İletişim bölümü - Hakkımızda sayfasındaki ile aynı */}
        <section id="iletisim">
